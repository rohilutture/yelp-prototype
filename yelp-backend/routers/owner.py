...
# ─── Get single owner restaurant (kept for backward compat) ──────────────────
...
# ─── Owner dashboard — aggregated across all owned restaurants ────────────────
...
# ─── Search unclaimed restaurants by name ─────────────────────────────────────
